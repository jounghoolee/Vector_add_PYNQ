...
#
# Generated by export_simulation on Sat Oct 03 13:42:33 KST 2020
#
################################################################################
...
'-reset_run' switch to the './vector_add_1.sh' script.

./vector_add_1.sh -reset_run
...
./vector_add_1.sh -noclean_files

For more information on the script, please type './vector_add_1.sh -help'.
