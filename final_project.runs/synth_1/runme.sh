...
HD_PWD='/home/jounghoolee/alveoServer/Xilinx/PynqDeepDive/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vector_add_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vector_add_1_wrapper.tcl
