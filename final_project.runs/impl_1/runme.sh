...
HD_PWD='/home/jounghoolee/alveoServer/Xilinx/PynqDeepDive/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vector_add_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vector_add_1_wrapper.tcl -notrace
